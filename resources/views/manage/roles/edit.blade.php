            ...
            <article class="media">
              <div class="media-content">
                <div class="content">
                  ...
                  <input type="hidden" native-value="permissionsSelected" name="permissions">
                </div>
              </div>
            </article>
          </div>
                ...
                <div class="content">
                  <h1 class="title">Permissions:</h1>
                    @foreach ($permissions as $permission)
                      <div class="field">
                        <b-checkbox name="permissionsSelected" v-model="permissionsSelected" native-value="{{$permission->id}}">{{$permission->display_name}} <em>({{$permission->description}})</em></b-checkbox>
                      </div>
                    @endforeach
                </div>
              </div>
